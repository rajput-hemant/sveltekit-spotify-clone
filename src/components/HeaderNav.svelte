<!-- https://github.com/alialaa/svelte-spotify/blob/main/src/lib/components/Header.svelte -->
...
<IconButton
	...
	icon={ChevronLeft}
	class="nav-button mr-1.5 h-9 w-9 rounded-full bg-menu-bg active:bg-accent"
/>
